...
protocol VirtualCurrencyVCProtocol: BaseViewController, LoadStatable { }

class VirtualCurrencyVC: BaseViewController, VirtualCurrencyVCProtocol
{
    // LoadStatable
    ...
    {
        super.viewDidLoad()
        titleLabel.attributedText = L10n.VirtualCurrency.title.attributed(.heading1, color: .xsolla_white)
    ...
    private func getTabbarItems() -> [TabbarViewController.Item]
    {
        ...
        for group in groups
        {
            ...
            tableView.registerXib(for: VirtualCurrencyCell.self)
...
extension VirtualCurrencyVC: LoadStatable
{
...
extension VirtualCurrencyVC: EmbeddableControllerContainerProtocol
{
