...
class AppStateProvider: AppStateProviderProtocol
{
    ...
    {
        if params.loginInfoProvider.userLogedIn == false { return .authenticating }
...
extension AppStateProvider
{
    struct Params
    {
        let loginInfoProvider: LoginInfoProvider
    }
}
