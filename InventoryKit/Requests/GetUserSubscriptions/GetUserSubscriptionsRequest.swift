...
class GetUserSubscriptionsRequest: InventoryBaseRequest<GetUserSubscriptionsRequest.Params>,
                                   APIRequestProtocol
{
    typealias ResponseModel = GetUserSubscriptionsResponse
    typealias ErrorHandler  = GetUserSubscriptionsErrorHandler
    ...
    override var relativePath: String { "/v2/project/\(String(params.projectId))/user/subscriptions" }
...
extension GetUserSubscriptionsRequest
{
