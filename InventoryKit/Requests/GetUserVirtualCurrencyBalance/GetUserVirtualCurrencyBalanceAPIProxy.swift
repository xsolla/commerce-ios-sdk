...
class GetUserVirtualCurrencyBalanceAPIProxy: APIBaseProxy
{
        ...
        completion: @escaping (InventoryAPIResult<GetUserVirtualCurrencyBalanceResponse>) -> Void)
    {
        ...
        let request = GetUserVirtualCurrencyBalanceRequest(params: params, apiConfiguration: apiConfiguration)
