...
class GetVirtualItemsAPIProxy: StoreBaseAPIProxy
{
    ...
    {
        let params = GetVirtualItemsRequest.Params(projectId: projectId,
        ...
        let request = GetVirtualItemsRequest(params: params, apiConfiguration: apiConfiguration)
