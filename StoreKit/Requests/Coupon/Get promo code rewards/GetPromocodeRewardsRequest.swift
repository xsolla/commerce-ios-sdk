...
// https://developers.xsolla.com/api/igs-bb/operation/get-promo-code-rewards-by-code/

class GetPromocodeRewardsRequest: StoreBaseRequest<GetPromocodeRewardsRequest.Params>, APIRequestProtocol
{
    typealias ResponseModel = GetPromocodeRewardsResponse
    ...
    {
        "/v2/project/\(String(params.projectId))/promocode/code/\(params.promocodeCode)/rewards"
    }
...
extension GetPromocodeRewardsRequest
{
