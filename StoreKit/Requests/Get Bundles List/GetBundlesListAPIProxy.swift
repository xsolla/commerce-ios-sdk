...
class GetBundlesListAPIProxy: APIBaseProxy
{
    ...
    {
        let params = GetBundlesListRequest.Params(projectId: projectId,
        ...
        let request = GetBundlesListRequest(params: params, apiConfiguration: apiConfiguration)
