...
// https://developers.xsolla.com/store-api/virtual-items-currency/catalog/get-virtual-items-group/

class GetItemsOfGroupRequest: StoreBaseRequest<GetItemsOfGroupRequest.Params>,
                              APIRequestProtocol
{
    typealias ResponseModel = GetItemsOfGroupResponse
    typealias ErrorHandler  = GetItemsOfGroupErrorHandler
    ...
    {
        "/v2/project/\(String(params.projectId))/items/virtual_items/group/\(params.externalId)"
    }
...
extension GetItemsOfGroupRequest
{
