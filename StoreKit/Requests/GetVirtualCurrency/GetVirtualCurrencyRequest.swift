...
// https://developers.xsolla.com/store-api/virtual-items-currency/catalog/get-virtual-currency/

class GetVirtualCurrencyRequest: StoreBaseRequest<GetVirtualCurrencyRequest.Params>,
                                 APIRequestProtocol
{
    typealias ResponseModel = GetVirtualCurrencyResponse
    typealias ErrorHandler  = GetVirtualCurrencyErrorHandler
    ...
    override var relativePath: String { "/v2/project/\(String(params.projectId))/items/virtual_currency" }
...
extension GetVirtualCurrencyRequest
{
