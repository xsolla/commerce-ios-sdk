...
class PurchaseItemByVirtualCurrencyAPIProxy: APIBaseProxy
{
        ...
        completion: @escaping ((StoreAPIResult<PurchaseItemByVirtualCurrencyResponse>) -> Void))
    {
        ...
        let request = PurchaseItemByVirtualCurrencyRequest(params: params, apiConfiguration: apiConfiguration)
