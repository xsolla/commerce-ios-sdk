...
class GetItemsOfGroupAPIProxy: APIBaseProxy
{
    ...
    {
        let params = GetItemsOfGroupRequest.Params(projectId: projectId,
        ...
        let request = GetItemsOfGroupRequest(params: params, apiConfiguration: apiConfiguration)
