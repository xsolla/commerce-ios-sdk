...
// https://developers.xsolla.com/store-api/items/get-virtual-currency-package/

class GetVirtualCurrencyPackagesRequest: StoreBaseRequest<GetVirtualCurrencyRequest.Params>,
                                         APIRequestProtocol
{
    typealias ResponseModel = GetVirtualCurrencyPackagesResponse
    typealias ErrorHandler  = GetVirtualCurrencyPackagesErrorHandler
    ...
    override var relativePath: String { "/v2/project/\(String(params.projectId))/items/virtual_currency/package" }
...
extension GetVirtualCurrencyPackagesRequest
{
