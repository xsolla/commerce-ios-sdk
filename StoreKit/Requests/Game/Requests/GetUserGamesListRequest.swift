...
// https://developers.xsolla.com/api/igs-bb/operation/get-user-games/

class GetUserGamesListRequest: StoreBaseRequest<GetUserGamesListRequest.Params>, APIRequestProtocol
{
    typealias ResponseModel = UserGamesListResponse
    ...
    override var relativePath: String { "/v2/project/\(String(params.projectId))/entitlement" }
...
extension GetUserGamesListRequest
{
