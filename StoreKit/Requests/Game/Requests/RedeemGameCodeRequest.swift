...
class RedeemGameCodeRequest: StoreBaseRequest<RedeemGameCodeRequest.Params>, APIRequestProtocol
{
    ...
    override var relativePath: String { "/v2/project/\(String(params.projectId))/entitlement/redeem" }
...
extension RedeemGameCodeRequest
{
