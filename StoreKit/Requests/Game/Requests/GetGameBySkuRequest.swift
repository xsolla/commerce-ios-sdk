...
// https://developers.xsolla.com/api/igs-bb/operation/get-game-by-sku/

class GetGameBySkuRequest: StoreBaseRequest<GetGameBySkuRequest.Params>, APIRequestProtocol
{
    typealias ResponseModel = GameResponse
    ...
    override var relativePath: String { "/v2/project/\(String(params.projectId))/items/game/sku/\(params.itemSku)" }
