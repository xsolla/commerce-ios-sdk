...
// https://developers.xsolla.com/api/igs-bb/operation/get-game-key-by-sku/

class GetGameKeyBySkuRequest: StoreBaseRequest<GetGameKeyBySkuRequest.Params>, APIRequestProtocol
{
    ...
    override var relativePath: String { "/v2/project/\(String(params.projectId))/items/game/key/sku/\(params.itemSku)" }
...
extension GetGameKeyBySkuRequest
{
