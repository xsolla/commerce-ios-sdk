...
// https://developers.xsolla.com/api/igs-bb/operation/get-games-group/

class GetGamesListByGroupRequest: StoreBaseRequest<GetGamesListByGroupRequest.Params>, APIRequestProtocol
{
    ...
    override var relativePath: String { "/v2/project/\(String(params.projectId))/items/game/group/\(params.externalId)" }
...
extension GetGamesListByGroupRequest
{
