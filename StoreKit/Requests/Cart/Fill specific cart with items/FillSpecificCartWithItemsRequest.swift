...
// https://developers.xsolla.com/api/igs-bb/operation/cart-fill-by-id/

class FillSpecificCartWithItemsRequest: StoreBaseRequest<FillSpecificCartWithItemsRequest.Params>,
                                        APIRequestProtocol
{
    typealias ResponseModel = FillSpecificCartWithItemsResponse
    ...
    override var relativePath: String { "/v2/project/\(String(params.projectId))/cart/\(String(params.cartId))/fill" }
...
extension FillSpecificCartWithItemsRequest
{
