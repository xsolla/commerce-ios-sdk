...
// https://developers.xsolla.com/api/igs-bb/operation/delete-item-by-cart-id/

class DeleteCartItemByCartIdRequest: StoreBaseRequest<DeleteCartItemByCartIdRequest.Params>,
                                     APIRequestProtocol
{
    ...
    {
        "/v2/project/\(String(params.projectId))/cart/\(String(params.cartId))/item/\(String(params.itemSKU))"
    }
...
extension DeleteCartItemByCartIdRequest
{
