...
// https://developers.xsolla.com/api/igs-bb/operation/delete-item/

class DeleteCartItemFromCurrentCartRequest: StoreBaseRequest<DeleteCartItemFromCurrentCartRequest.Params>,
                                     APIRequestProtocol
{
...
extension DeleteCartItemFromCurrentCartRequest
{
