...
// https://developers.xsolla.com/api/igs-bb/operation/put-item-by-cart-id/

class UpdateCartItemByCartIdRequest: StoreBaseRequest<UpdateCartItemByCartIdRequest.Params>,
                                     APIRequestProtocol
{
...
extension UpdateCartItemByCartIdRequest
{
