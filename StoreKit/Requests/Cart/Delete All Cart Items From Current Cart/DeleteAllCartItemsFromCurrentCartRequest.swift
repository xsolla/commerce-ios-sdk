...
// https://developers.xsolla.com/api/igs-bb/operation/cart-clear/

class DeleteAllCartItemsFromCurrentCartRequest: StoreBaseRequest<DeleteAllCartItemsFromCurrentCartRequest.Params>,
                                                APIRequestProtocol
{
    ...
    override var relativePath: String { "/v2/project/\(String(params.projectId))/cart/clear" }
...
extension DeleteAllCartItemsFromCurrentCartRequest
{
