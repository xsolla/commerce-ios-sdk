...
// https://developers.xsolla.com/api/igs-bb/operation/create-order/

class CreateOrderFromCurrentCartRequest: StoreBaseRequest<CreateOrderFromCurrentCartRequest.Params>, APIRequestProtocol
{
    ...
    override var relativePath: String { "/v2/project/\(String(params.projectId))/payment/cart" }
...
extension CreateOrderFromCurrentCartRequest
{
