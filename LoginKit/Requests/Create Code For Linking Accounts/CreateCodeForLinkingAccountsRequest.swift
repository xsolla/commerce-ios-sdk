...
// https://developers.xsolla.com/login-api/linking-account/linking/create-code-for-linking-accounts/

class CreateCodeForLinkingAccountsRequest: LoginBaseRequest<CreateCodeForLinkingAccountsRequest.Params>,
                                           APIRequestProtocol
{
    ...
    override var relativePath: String { "/users/account/code" }
...
extension CreateCodeForLinkingAccountsRequest
{
