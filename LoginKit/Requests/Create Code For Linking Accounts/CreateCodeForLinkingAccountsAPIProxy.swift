...
class CreateCodeForLinkingAccountsAPIProxy: LoginBaseAPIProxy
{
                                      ...
                                      completion: @escaping (LoginAPIResult<String>) -> Void)
    {
        ...
        let request = CreateCodeForLinkingAccountsRequest(params: params, apiConfiguration: apiConfiguration)
