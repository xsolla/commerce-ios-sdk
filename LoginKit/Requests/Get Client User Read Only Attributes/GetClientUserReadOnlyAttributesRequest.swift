...
class GetClientUserReadOnlyAttributesRequest: LoginBaseRequest<GetClientUserReadOnlyAttributesRequest.Params>,
                                              APIRequestProtocol
{
    ...
    override var relativePath: String { "/attributes/users/me/get_read_only" }
...
extension GetClientUserReadOnlyAttributesRequest
{
