...
class GetClientUserReadOnlyAttributesAPIProxy: APIBaseProxy
{
                                         ...
                                         completion: @escaping (LoginAPIResult<GetClientUserReadOnlyAttributesResponse>) -> Void)
    {
        ...
        let request = GetClientUserReadOnlyAttributesRequest(params: params, apiConfiguration: apiConfiguration)
