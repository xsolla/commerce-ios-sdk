...
class GetURLToLinkSocialNetworkToAccountAPIProxy: APIBaseProxy
{
        ...
        completion: @escaping (LoginAPIResult<GetURLToLinkSocialNetworkToAccountResponse>) -> Void)
    {
        ...
        let request = GetURLToLinkSocialNetworkToAccountRequest(params: params, apiConfiguration: apiConfiguration)
