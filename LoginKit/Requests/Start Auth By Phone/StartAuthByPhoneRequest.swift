...
class StartAuthByPhoneRequest: LoginBaseRequest<StartAuthByPhoneRequest.Params>, APIRequestProtocol
{
    ...
    override var relativePath: String { "/oauth2/login/phone/request" }
    ...
    {
       Body(phone: params.phoneNumber, linkUrl: params.linkUrl, sendLink: params.sendLink)
    }
...
extension StartAuthByPhoneRequest
{
