...
// https://developers.xsolla.com/api/login/operation/delete-linked-networks/

class DeleteLinkedNetworkRequest: LoginBaseRequest<DeleteLinkedNetworkRequest.Params>,
                                  APIRequestProtocol
{
    ...
    override var relativePath: String { "/users/me/social_providers/\(params.providerName)" }
...
extension DeleteLinkedNetworkRequest
{
