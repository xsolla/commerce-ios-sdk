...
// https://developers.xsolla.com/login-api/user-account/managed-by-client/user-profile/update-user-phone-number

class UpdateCurrentUserPhoneRequest: LoginBaseRequest<UpdateCurrentUserPhoneRequest.Params>, APIRequestProtocol
{
    typealias ResponseModel = APIEmptyResponse
    typealias ErrorHandler = UpdateCurrentUserPhoneErrorHandler
    ...
    override var bodyParameters: Encodable? { ["phone_number": params.phoneNumber] }
...
extension UpdateCurrentUserPhoneRequest
{
