...
class LogUserOutAPIProxy: LoginBaseAPIProxy
{
    func logUserOut(accessToken: String,
                    ...
                    completion: @escaping (LoginAPIResult<Void>) -> Void)
    {
        ...
        let request = LogUserOutRequest(params: params, apiConfiguration: apiConfiguration)
