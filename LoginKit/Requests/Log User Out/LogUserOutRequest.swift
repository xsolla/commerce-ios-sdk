...
// https://developers.xsolla.com/login-api/auth/oauth-20/log-user-out

class LogUserOutRequest: LoginBaseRequest<LogUserOutRequest.Params>,
                         APIRequestProtocol
{
    typealias ResponseModel = APIEmptyResponse
    typealias ErrorHandler  = LogUserOutErrorHandler
    ...
    override var relativePath: String { "/oauth2/logout" }
    ...
    {
        [
            "sessions": params.sessionType.rawValue
        ]
    }
...
extension LogUserOutRequest
{
    struct Params: RequestParams
    {
        let accessToken: String
        let sessionType: LogoutSessionType
    }
}
