...
// https://developers.xsolla.com/login-api/user-account/managed-by-client/user-friends/get-user-public-profile/
...
class GetUserPublicProfileRequest: LoginBaseRequest<GetUserPublicProfileRequest.Params>, APIRequestProtocol
{
    ...
    override var relativePath: String { "/users/\(params.userId)/public" }
...
extension GetUserPublicProfileRequest
{
