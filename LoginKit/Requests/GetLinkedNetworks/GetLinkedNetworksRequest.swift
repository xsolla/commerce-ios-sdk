...
// https://developers.xsolla.com/login-api/user-account/managed-by-client/social-networks/get-linked-networks
...
class GetLinkedNetworksRequest: LoginBaseRequest<GetLinkedNetworksRequest.Params>, APIRequestProtocol
{
    ...
    override var relativePath: String { "/users/me/social_providers" }
...
extension GetLinkedNetworksRequest
{
